...
mv3 = sortedVCorners(35, 2);
    ...
    h = plot(mu0, mv0, 'x', 'Color', 'g', 'MarkerSize', 10);
    set(h, 'linewidth', 3);
    h = plot(mu1, mv1, 'x', 'Color', 'g', 'MarkerSize', 10);
    set(h, 'linewidth', 3);
    h = plot(mu2, mv2, 'x', 'Color', 'g', 'MarkerSize', 10);
    set(h, 'linewidth', 3);
    h = plot(mu3, mv3, 'x', 'Color', 'r', 'MarkerSize', 10);
    set(h, 'linewidth', 3);
