...
\begin{figure*}
  \centering
  \subfigure[Result of findHomography in OpenCV]{
    \label{findhomo-1} %% label for first subfigure
    \includegraphics[width=0.49\linewidth]{findhomo-1.jpeg}}
  \subfigure[Result of Our Four Point Rectification Approach]{
    \label{four-point-normal-1} %% label for second subfigure
    \includegraphics[width=0.49\linewidth]{four-point-normal-1.jpeg}}
 \subfigure[The Point Choice in Original Picture (Apexes of Highlighted Green Rectangle)]{
    \label{hw1-wall-rec} %% label for first subfigure
    \includegraphics[width=0.49\linewidth]{hw1-wall-rec.jpeg}}
...
\begin{figure*}
  \centering
  \subfigure[Result of Affine Rectification from the Wall]{
    \label{affinity-wall-1} %% label for first subfigure
    \includegraphics[width=0.49\linewidth]{affinity-wall-1.jpeg}}
  \subfigure[Result of Affine Rectification from Squares on the Floor]{
    \label{affinity-floor-1} %% label for second subfigure
    \includegraphics[width=0.49\linewidth]{affinity-floor-1.jpeg}}
 \subfigure[The Point Choice in Original Picture (Apexes of Highlighted Green Rectangle)]{
    \label{hw1-wall-rec} %% label for first subfigure
    \includegraphics[width=0.49\linewidth]{hw1-wall-rec.jpeg}}
  \caption{Affinely Rectification through Wall vs. Floor}
  \label{affine-rectify-wall-floor} %% label for entire figure
\end{figure*}
...
\begin{figure*}[!hpbt]
  \subfigure[Two-Step Rectification through Floor Square]{
\label{two-floor-1} %% label for second subfigure
\includegraphics[width=0.49\linewidth]{two-floor-1.jpeg}}
 \subfigure[The Point Choice in Original Picture (Apexes of Highlighted Green Rectangle)]{
    \label{hw1-floor-sqr} %% label for first subfigure
    \includegraphics[width=0.49\linewidth]{hw1-floor-sqr.jpg}}
  \caption{Two-Step Rectification through Floor Plane}
  \label{two-step-rectify-floor} %% label for entire figure
\end{figure*}
